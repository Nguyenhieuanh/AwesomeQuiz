                    ...
                    <div class="form-group">
                        <div class="col">
                            <div class="row">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="correct_select_{{$key+1}}"> <strong> Answer
                                                Option {{$key+1}}
                                            </strong>
                                        </label>
                                    </div>
                                    <select class="custom-select" id="correct_select_{{$key+1}}" name="correct_option[]">
                                        <option class="text-danger" value="0"
                                            {{($answer->correct == 0) ? 'selected' : ''}}>Wrong</option>
                                        <option class="text-success" value="1"
                                            {{($answer->correct == 1) ? 'selected' : ''}}>Right</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <textarea class="form-control @error('answer_content[]') is-invalid @enderror"
                            id="answer_content_1" name="answer_content[]" rows="2" required>{{ $answer->answer_content }}
                        </textarea>
                        @error('answer_content[]')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
